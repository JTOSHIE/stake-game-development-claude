...
| Trademark clearance: "We Roll Spinners", "Future Spinner" | IN PROGRESS | JOSH | Platform rule: team names, game titles and assets must comply with IP law; infringement is grounds for rejection. Run searches (IP Australia, USPTO, common-law web/app-store search) before submission; keep search records here. Exact-phrase quick searches clear on the official AU register 2026-07-15 (0 results both names); records at docs/records/trademark/2026-07-15/. Variant scan (classes 9/41) and USPTO exact checks pending. |
...
| Provider brand assets | IN PROGRESS | FABLE/JOSH | Square provider logo (transparent PNG) for Team Settings > Branding, displayed publicly on stake.com. Fable authors master next check-in; Josh uploads once. Hero emblem ratified and ingested (design-system/brand/hero_emblem/, 2026-07-15); flat vector mark evolution pending Fable's art turn. |
