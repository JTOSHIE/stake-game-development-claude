...
const de: Translations = {
  ...
  resumeBody:           'Du hast {played} von {total} Freispielen gesehen, bevor du gegangen bist. Dort fortsetzen oder die ganze Runde erneut ansehen.',
  ...
  rgRealityCheckBody:   'Du spielst seit {time}. Dein Nettoergebnis in dieser Sitzung beträgt {amount}.',
...
export const featureI18n: Record<Locale, FeatureStrings> = {
  en: {
    ...
    rulesOverdriveTrigger: '3, 4 or 5 Scatters award 8, 12 or 16 free spins and pay an instant 1×, 3× or 10× base bet.',
    rulesOverdriveMeter: 'The Overdrive meter starts at 1× (5× when entered via NITRO OVERDRIVE) and rises +1× after every winning free spin, multiplying all later wins. It never resets during the feature.',
    ...
    rulesOverdriveModes: 'All five bet modes return 96.35% RTP. Maximum win 5,000× base bet.',
  ...
  ar: {
    ...
    rulesOverdriveTrigger: '3 أو 4 أو 5 رموز سكاتر تمنح 8 أو 12 أو 16 لفة مجانية وتدفع فوراً 1× أو 3× أو 10× من الرهان الأساسي.',
    rulesOverdriveMeter: 'يبدأ عداد أوفردرايف من 1× (و5× عند الدخول عبر NITRO OVERDRIVE) ويرتفع 1× بعد كل لفة مجانية رابحة، مضاعفاً كل الأرباح اللاحقة. لا يعاد ضبطه خلال الميزة.',
    ...
    rulesOverdriveModes: 'تعيد جميع أوضاع الرهان الخمسة RTP بنسبة 96.35%. أقصى فوز 5,000× من الرهان الأساسي.',
  ...
  de: {
    ...
    rulesOverdriveTrigger: '3, 4 oder 5 Scatter vergeben 8, 12 oder 16 Freispiele und zahlen sofort 1×, 3× oder 10× des Basiseinsatzes.',
    rulesOverdriveMeter: 'Der Overdrive-Zähler startet bei 1× (5× bei Einstieg über NITRO OVERDRIVE) und steigt nach jedem gewonnenen Freispiel um 1×, was alle folgenden Gewinne multipliziert. Er wird während des Features nie zurückgesetzt.',
    ...
    recoveryResumed: 'Deine vorherige Runde wurde abgeschlossen und ihr Ergebnis angewendet.',
    ...
    rulesOverdriveModes: 'Alle fünf Einsatzmodi liefern 96,35 % RTP. Maximalgewinn 5.000× Basiseinsatz.',
  ...
  es: {
    ...
    rulesOverdriveTrigger: '3, 4 o 5 Scatters otorgan 8, 12 o 16 giros gratis y pagan al instante 1×, 3× o 10× de la apuesta base.',
    rulesOverdriveMeter: 'El medidor Overdrive empieza en 1× (5× al entrar mediante NITRO OVERDRIVE) y sube 1× tras cada giro gratis ganador, multiplicando todas las ganancias posteriores. No se reinicia durante la función.',
    ...
    rulesOverdriveModes: 'Los cinco modos de apuesta devuelven un RTP del 96,35 %. Ganancia máxima: 5.000× la apuesta base.',
    ...
    rulesOverdriveTrigger: '3, 4 tai 5 Scatteria antaa 8, 12 tai 16 ilmaiskierrosta ja maksaa heti 1×, 3× tai 10× peruspanoksesta.',
    rulesOverdriveMeter: 'Overdrive-mittari alkaa arvosta 1× (5× NITRO OVERDRIVE -tilan kautta) ja nousee 1× jokaisen voittavan ilmaiskierroksen jälkeen kertoen kaikki myöhemmät voitot. Se ei nollaudu ominaisuuden aikana.',
    ...
    rulesOverdriveModes: 'Kaikki viisi panostilaa palauttavat 96,35 % RTP. Maksimivoitto 5 000× peruspanos.',
    introContinue: 'Jatka',
  ...
  fr: {
    ...
    rulesOverdriveTrigger: '3, 4 ou 5 Scatters accordent 8, 12 ou 16 tours gratuits et paient instantanément 1×, 3× ou 10× la mise de base.',
    rulesOverdriveMeter: 'Le compteur Overdrive démarre à 1× (5× en cas d\'entrée via NITRO OVERDRIVE) et augmente de 1× après chaque tour gratuit gagnant, multipliant tous les gains suivants. Il ne se réinitialise jamais pendant la fonction.',
    ...
    rulesOverdriveModes: 'Les cinq modes de mise offrent un RTP de 96,35 %. Gain maximum : 5 000× la mise de base.',
  ...
  hi: {
    ...
    rulesOverdriveTrigger: '3, 4 या 5 स्कैटर 8, 12 या 16 फ्री स्पिन देते हैं और तुरंत बेस बेट का 1×, 3× या 10× भुगतान करते हैं।',
    rulesOverdriveMeter: 'ओवरड्राइव मीटर 1× (NITRO OVERDRIVE से प्रवेश पर 5×) से शुरू होता है और हर जीतने वाले फ्री स्पिन के बाद 1× बढ़ता है, बाद की सभी जीतों को गुणा करता है। फ़ीचर के दौरान यह रीसेट नहीं होता।',
    ...
    rulesOverdriveModes: 'सभी पांच बेट मोड 96.35% RTP देते हैं। अधिकतम जीत 5,000× बेस बेट।',
  ...
  id: {
    ...
    rulesOverdriveTrigger: '3, 4 atau 5 Scatter memberikan 8, 12 atau 16 free spin dan langsung membayar 1×, 3× atau 10× dari taruhan dasar.',
    rulesOverdriveMeter: 'Meter Overdrive dimulai dari 1× (5× jika masuk melalui NITRO OVERDRIVE) dan naik 1× setelah setiap free spin yang menang, mengalikan semua kemenangan berikutnya. Meter tidak pernah direset selama fitur.',
    ...
    rulesOverdriveModes: 'Kelima mode taruhan menghasilkan RTP 96,35%. Kemenangan maksimum 5.000× taruhan dasar.',
  ...
  ja: {
    ...
    rulesOverdriveTrigger: 'スキャッター3・4・5個で8・12・16回のフリースピンを獲得し、基本ベットの1倍・3倍・10倍を即時に配当します。',
    rulesOverdriveMeter: 'オーバードライブメーターは1倍（NITRO OVERDRIVE経由の場合は5×）から始まり、勝利したフリースピンごとに1倍上昇し、以降のすべての配当に乗算されます。フィーチャー中はリセットされません。',
    ...
    rulesOverdriveModes: '5つのベットモードはすべてRTP 96.35%です。最大配当は基本ベットの5,000×。',
    introContinue: '続ける',
  ...
  ko: {
    ...
    rulesOverdriveTrigger: '스캐터 3, 4 또는 5개가 8, 12 또는 16회의 프리 스핀을 지급하고 기본 베팅액의 1×, 3× 또는 10×를 즉시 지급합니다.',
    rulesOverdriveMeter: '오버드라이브 미터는 1× (NITRO OVERDRIVE로 진입 시 5×)에서 시작하여 당첨된 프리 스핀마다 1× 상승하며 이후 모든 당첨에 곱해집니다. 기능 중에는 초기화되지 않습니다.',
    ...
    rulesOverdriveModes: '다섯 가지 베팅 모드 모두 RTP 96.35%입니다. 최대 당첨금은 기본 베팅의 5,000×.',
    introContinue: '계속',
  ...
  pl: {
    ...
    rulesOverdriveTrigger: '3, 4 lub 5 symboli Scatter przyznaje 8, 12 lub 16 darmowych spinów i natychmiast wypłaca 1×, 3× lub 10× stawki bazowej.',
    rulesOverdriveMeter: 'Licznik Overdrive zaczyna od 1× (5× przy wejściu przez NITRO OVERDRIVE) i rośnie o 1× po każdym wygranym darmowym spinie, mnożąc wszystkie kolejne wygrane. Nie resetuje się podczas funkcji.',
    ...
    rulesOverdriveModes: 'Wszystkie pięć trybów zakładów zwraca RTP 96,35%. Maksymalna wygrana 5 000× stawki bazowej.',
  ...
  pt: {
    ...
    rulesOverdriveTrigger: '3, 4 ou 5 Scatters concedem 8, 12 ou 16 giros grátis e pagam instantaneamente 1×, 3× ou 10× da aposta base.',
    rulesOverdriveMeter: 'O medidor Overdrive começa em 1× (5× ao entrar via NITRO OVERDRIVE) e sobe 1× após cada giro grátis vencedor, multiplicando todos os ganhos seguintes. Nunca é reiniciado durante o recurso.',
    ...
    rulesOverdriveModes: 'Os cinco modos de aposta devolvem 96,35% de RTP. Ganho máximo de 5.000× a aposta base.',
    introContinue: 'Continuar',
  ...
  ru: {
    ...
    rulesOverdriveTrigger: '3, 4 или 5 скаттеров дают 8, 12 или 16 фриспинов и мгновенно выплачивают 1×, 3× или 10× от базовой ставки.',
    rulesOverdriveMeter: 'Счётчик Овердрайв начинается с 1× (5× при входе через NITRO OVERDRIVE) и растёт на 1× после каждого выигрышного фриспина, умножая все последующие выигрыши. Он не сбрасывается во время функции.',
    ...
    rulesOverdriveModes: 'Все пять режимов ставок возвращают RTP 96,35 %. Максимальный выигрыш 5 000× от базовой ставки.',
  ...
  tr: {
    ...
    rulesOverdriveTrigger: '3, 4 veya 5 Scatter 8, 12 veya 16 bedava dönüş verir ve anında temel bahsin 1×, 3× veya 10× katını öder.',
    rulesOverdriveMeter: 'Overdrive göstergesi 1× (NITRO OVERDRIVE ile girişte 5×) ile başlar ve kazanan her bedava dönüşün ardından 1× artarak sonraki tüm kazançları çarpar. Özellik boyunca sıfırlanmaz.',
    ...
    rulesOverdriveModes: 'Beş bahis modunun tümü %96,35 RTP döndürür. Maksimum kazanç temel bahsin 5.000× katı.',
  ...
  vi: {
    ...
    rulesOverdriveTrigger: '3, 4 hoặc 5 biểu tượng Scatter trao 8, 12 hoặc 16 vòng quay miễn phí và trả ngay 1×, 3× hoặc 10× tiền cược cơ bản.',
    rulesOverdriveMeter: 'Đồng hồ Overdrive bắt đầu ở 1× (5× khi vào qua NITRO OVERDRIVE) và tăng 1× sau mỗi vòng quay miễn phí thắng, nhân tất cả các phần thắng sau đó. Nó không bao giờ đặt lại trong tính năng.',
    ...
    rulesOverdriveModes: 'Cả năm chế độ cược đều có RTP 96,35%. Mức thắng tối đa 5.000× cược cơ bản.',
  ...
  zh: {
    ...
    rulesOverdriveTrigger: '3、4 或 5 个分散符号可获得 8、12 或 16 次免费旋转，并立即支付基础投注的 1 倍、3 倍或 10 倍。',
    rulesOverdriveMeter: '超载计量表从 1 倍（通过 NITRO OVERDRIVE 进入时为 5×）开始，每次赢得免费旋转后增加 1 倍，乘以之后的所有赢额。功能期间不会重置。',
    ...
    rulesOverdriveModes: '全部五种投注模式的RTP均为96.35%。最高赢额为基础投注的5,000×。',
    introContinue: '继续',
...
export const SOCIAL_OVERRIDES: Partial<Record<keyof Translations, string>> = {
  ...
  rulesOverdriveTrigger:
    'Land 3, 4 or 5 Scatters to get 8, 12 or 16 free spins and an instant 1×, 3× or 10× of your base play.',
  rulesOverdriveMeter:
    'The Overdrive meter starts at 1× (5× when entered via NITRO OVERDRIVE) and rises +1× after every winning free spin, multiplying all later prizes. It never resets during the feature.',
  ...
  rulesOverdriveModes:
    'All five play modes return 96.35% RTP. Maximum prize 5,000× base play.',
}
