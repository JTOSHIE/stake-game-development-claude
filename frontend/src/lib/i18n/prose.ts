...
export const en: ProseStrings = {
  ...
  modeOverboostBlurb: 'Double-chance: about 1.6x the feature trigger rate. Debits 1.25x every spin while ON.',
...
export const PROSE_SOCIAL: Partial<Record<ProseKey, string>> = {
  ...
  modeOverboostBlurb: 'Double-chance: about 1.6x the feature trigger rate. Costs 1.25x every spin while ON.',
  modeBonusLabel: 'Get Overdrive',
  modeBonusBlurb: 'Get a guaranteed Overdrive Free Spins entry.',
  modeSuperBlurb: 'Get a rich entry with the Overdrive meter pre-revved to 5x.',
