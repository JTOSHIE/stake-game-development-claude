...
# Stake compliance rubric (from the approval guidelines + community tools).
RTP_MIN, RTP_MAX = 0.90, 0.98
CROSS_MODE_MAX = 0.005          # RTP variation vs base
BASE_HIT_MIN, BASE_HIT_MAX = 0.05, 0.33
MIN_ROWS = 100_000
MIN_UNIQUE_PAYOUTS = 10
MAX_ZERO_RATE = 0.90
MAX_WIN_ACHIEVABLE_ONE_IN = 20_000_000  # max win must be reachable (odds <= 1 in 20M)
