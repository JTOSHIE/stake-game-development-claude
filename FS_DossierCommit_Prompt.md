FS_DossierCommit_Prompt.md. Save this brief verbatim as FS_DossierCommit_Prompt.md and commit it with this session per convention.

On a new branch claude/submission-dossier from up-to-date main: create SUBMISSION_DOSSIER.md in the repo root containing EXACTLY the content between the BEGIN and END markers below, then git rm SUBMISSION_CHECKLIST.md, write reports/SESSION_REPORT.md plus the dated archive copy, commit, push, and open the PR into main via gh titled "Submission dossier v1, checklist retired" with the session report as description.

--- BEGIN SUBMISSION_DOSSIER.md ---
...
| 10 | Compliance evidence pack (section 4) | Audits + re-validation pass | Base complete; Stage 2 items open | Compliance re-validation |
