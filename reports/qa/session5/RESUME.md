...
| 5 | JOB 5 | S2-C017, the focus ring matched mouse focus | (this commit) | about 460k of 740k | **DONE.** `button:focus` no longer paints; `button:focus-visible` carries a designed ring. Proven by computed style, not by reading CSS. Layout fit gate PASS |
