...
| REQ-016 | ARTEFACT | YES | `approval_guidelines_general_disclaimer.md:22` | Present in the platform's template disclaimer as its closing line. Whether this line is itself mandatory, or is merely part of the template a studio may replace with its own wording under R1-19, is UNKNOWN from this page; note also that it sits against the project's own no-Stake-branding rule and should be ruled on rather than assumed. | 1 | R1-26 |
