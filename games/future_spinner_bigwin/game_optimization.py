...
class OptimizationSetup:
    ...
    def __init__(self, game_config):
        ...
        # Fall back to the game cap for modes trimmed out of this proof skin, so
        # the opt_params literal (which references all library modes) still builds.
        wincaps = defaultdict(
        ...
        # BIGWIN proof skin: keep only the shipped three modes' fences.
