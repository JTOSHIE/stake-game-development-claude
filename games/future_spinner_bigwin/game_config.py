...
_BASE_RTP = 0.9635   # Shared RTP target across all bet modes
_WINCAP = 25000.0    # HIGHER-CAP SKIN: 25,000x (vs the 5,000x base skin). One-line
                     # change; the whole package regenerates at the new cap.
...
class GameConfig(Config):
    ...
    def __init__(self):
        ...
        # -- Identity ----------------------------------------------------------
        self.game_id = "future_spinner_bigwin"
        ...
        # BIGWIN proof skin: ship only these three modes at the 25,000x cap.
        _BIGWIN_MODES = {"base", "bonus", "superbuy"}
        self.bet_modes = [bm for bm in self.bet_modes if bm.get_name() in _BIGWIN_MODES]
