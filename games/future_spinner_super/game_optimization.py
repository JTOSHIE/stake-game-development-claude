...
class OptimizationSetup:
    ...
    def __init__(self, game_config):
        ...
        self.game_config.opt_params = {
            ...
            "super": {
                # 400x buy with the Overdrive meter pre-revved to 5x (gamestate).
                # Same buy fence shape as bonus (wincap 0.05 + always-on freegame
                # 0.9135 = 0.9635); the cost scales the mean to 0.9635 x 400 =
                # 385.4x. Dress centred on the pre-revved feature body. Tail gate
                # at cost 400 uses cost_scale 0.8.
                "conditions": {
                    "wincap": ConstructConditions(
