...
class GameConfig(Config):
    ...
    def __init__(self):
        ...
        # -- Identity ----------------------------------------------------------
        self.game_id = "future_spinner_multiwild"
        ...
        # -- Special symbols ---------------------------------------------------
        # MULTIWILD variant: Wild carries a random multiplier during free spins,
        # combined with the Overdrive meter via the "combined" ways strategy.
        self.special_symbols = {
            "wild": ["W"],
            "scatter": ["S"],
            "multiplier": ["W"],
        }
        # Weighted multiplier values a Wild takes when it lands in free spins.
        self.wild_mult_values = {2: 50, 3: 30, 5: 15, 10: 5}
        ...
        _MULTIWILD_MODES = {"base", "bonus"}
        self.bet_modes = [bm for bm in self.bet_modes if bm.get_name() in _MULTIWILD_MODES]
