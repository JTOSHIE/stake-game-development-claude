...
class OptimizationSetup:
    ...
    def __init__(self, game_config):
        ...
        wincaps = defaultdict(lambda: game_config.wincap, {bm.get_name(): bm.get_wincap() for bm in game_config.bet_modes})
        ...
        self.game_config.opt_params = {
            "base": {
                "conditions": {
                    ...
                    "basegame": ConstructConditions(rtp=0.51, hr=3.5).return_dict(),
                },
            ...
            "bonus": {
                "conditions": {
                    ...
                    "freegame": ConstructConditions(rtp=0.89, hr="x").return_dict(),
                },
                "scaling": ConstructScaling(
                    [
        ...
        self.game_config.opt_params = {k: v for k, v in self.game_config.opt_params.items() if k in _keep}
