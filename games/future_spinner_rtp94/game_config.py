...
_BASE_RTP = 0.9400   # Shared RTP target across both bet modes
...
class GameConfig(Config):
    ...
    def __init__(self):
        ...
        # -- Identity ----------------------------------------------------------
        self.game_id = "future_spinner_rtp94"
        ...
        _RTP94_MODES = {"base", "bonus"}
        self.bet_modes = [bm for bm in self.bet_modes if bm.get_name() in _RTP94_MODES]
