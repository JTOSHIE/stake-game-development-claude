...
if __name__ == "__main__":
    ...
    # Four stateless modes: surface (1.0x, base profile), deepdive (1.5x, ~2x
    # trigger rate / double-chance), bloom bonus buy (100.0x) and abyssalbloom
    # super buy (300.0x). All target 96.35% RTP (within the 0.5% cross-mode band)
    # with a 10,000x hard cap and the Glow Meter free-spin engine.
    target_modes = ["surface", "deepdive", "bloom", "abyssalbloom"]
    ...
    print("=" * 60)
    print("LUMEN - We Roll Spinners - Glow Meter Free Spins")
