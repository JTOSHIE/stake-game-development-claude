<script lang="ts">
  ...
  // LUMEN ships a single flat H1 sprite (no h1_base/h1_spin layered art), so the
  // layered-overlay map is empty here and H1 renders from plain h1.png like every
  // other symbol. Restore the H1 entry if a layered LUMEN H1 is ever produced.
