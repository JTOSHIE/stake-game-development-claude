...
<div class="instrument-column" data-testid="bonus-instrument-column">
  <div class="gauge" style="width:232px;height:232px;">
    <!-- LUMEN reuses the vertical glow_meter art as the gauge face. There is no
         separate needle sprite (a rotating needle over a vertical bar meter has
         no meaning), so it is not rendered; the meter fill and the MULTIPLIER
         plate below convey the live value. -->
    <img
      class="gauge-face"
